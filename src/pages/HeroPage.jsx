      ...
      <Div className={cn('h-72 xs:h-80 sm:h-96 md:h-120 w-full md:w-3/5 flex flex-col justify-around')}>
        <Div className={cn('flex')}>
          ...
          <Div className={cn('w-1/2 md:hidden')}>
            <Img className={cn('object-fill mb-2 w-full h-52 xs:h-64 sm:h-80 rounded-lg dark:rounded-lg')} src="https://img.freepik.com/premium-photo/happy-family-warm-clothing-with-luggage-white-background-ready-winter-vacation_392895-57857.jpg?size=626&ext=jpg&ga=GA1.2.1633012741.1684645608&semt=ais" alt="" />
          </Div>
        </Div>
